...
# Filtrar las columnas que contienen 'percentile' en su nombre
columns_to_remove = [col for col in data.columns if 'percentile' in col]

# Eliminar las columnas de 'data'
...
plot_filename_local = os.path.join(local_directory, 'ganancia_por_mes_SinPercentilar.png')
csv_filename_local = os.path.join(local_directory, 'ganancias_SinPercentilar.csv')
